...
import BfcacheRefresh from "@modules/layout/components/bfcache-refresh" // <-- добавлено
  ...
  return (
    <div className="sticky top-0 inset-x-0 z-50 group">
      <header className="relative h-16 mx-auto border-b duration-200 bg-white border-ui-border-base">
        {/* Никакой логики не меняем — просто монтируем «невидимый» клиентский компонент */}
        <BfcacheRefresh />
