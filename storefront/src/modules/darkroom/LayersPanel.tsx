        ...
        {items.map((it, i) => (
          ...
          >
            <div className="flex flex-col">
              <button
                className="w-6 h-6 grid place-items-center border border-current bg-transparent mb-1"
              ...
              <button
                className="w-6 h-6 grid place-items-center border border-current bg-transparent"
