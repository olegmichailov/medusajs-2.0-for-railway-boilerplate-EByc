...
export default function EditorCanvas() {
  ...
  // ===== Transformer (текст: боковые якоря = width; углы = fontSize) =====
  ...
  // ===== Жесты (перетаскивание 1 палец; 2 пальца — масштаб/поворот вокруг центра жеста) =====
  type G = {
    active: boolean
    two: boolean
    startDist: number
