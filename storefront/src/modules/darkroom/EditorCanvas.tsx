...
export default function EditorCanvas() {
  ...
  // ===== Transformer (фикс «пружины» у текста)
  ...
  const setSelectedText       = (tstr:string) => { const n = sel?.node as Konva.Text; if (!n) return; n.text(tstr); artRef.current?.batchDraw() }
